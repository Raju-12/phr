...
////////////*************for patent's***********************//
	...
	if(isset($_POST['plogin'])){
		...
		if(pemail_exists()){
			$query=mysqli_query($link,"SELECT ppwd FROM p_registration WHERE pemail ='$pemail'");
			$row =mysqli_fetch_assoc($query);
			if($ppwd==$row['ppwd']){
				$_SESSION['success']="logged in";
				header('location: paitent/index.php');
			}
			else{
				echo "<div class='alert alert-danger'>
				passwod does not match
...
<div class="container">
	...
	<div class="registration" >
		...
		<img src="images/med.jpg" alt="">
			<button onclick="document.getElementById('id02').style.display='block'" style="width:auto; border-radius:5%;">Paitent's Login</button>
		</div>
	</div>
  </div>
...
<div id="id02" class="modal">
  ...
  <form class="modal-content animate"  action=""  method="post">
    ...
    <div class="container">
      ...
      <label for="psw"><b>Password</b></label>
      <input type="password" placeholder="Enter Password" name="ppwd" required>
